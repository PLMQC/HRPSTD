codeunit 33001211 "Salary Adjust Process B2B"
{
    ...
    begin
        ...
        LOPAdjEntriesLRec.SETRANGE(Type, LOPAdjEntriesLRec.Type::Addition);
    ...
    var
        ...
        DailyAttendanceLRec: Record "Daily Attendance B2B";
        Basic: Decimal;
        DA: Decimal;
        DayAmount: Decimal;
        OTAmount: Decimal;
    ...
    begin
        ...
        DailyAttendanceLRec.SETRANGE("Employee No.", MonAttendance."Employee Code");
        DailyAttendanceLRec.SETFILTER(Date, '%1..%2', MonthlyAttendance2GRec."Period Start Date", MonthlyAttendance2GRec."Period End Date");
        DailyAttendanceLRec.SETFILTER(DailyAttendanceLRec."OT Approved Hrs", '<> 0');
        if DailyAttendanceLRec.FINDFIRST() then begin
            repeat
                VADLRec.SETRANGE("Employee Code", DailyAttendanceLRec."Employee No.");
                ...
                PayElements.SETRANGE("Employee Code", DailyAttendanceLRec."Employee No.");
                PayElements.SETRANGE("Applicable for OT", true);
                if PayElements.FINDFIRST() then
                    repeat
                        Total := 0;
                        VAD2LRec.SETFILTER(VAD2LRec."Effective Start Date", '<= %1', DailyAttendanceLRec.Date);
                        VAD2LRec.SETRANGE("Employee Code", PayElements."Employee Code");
                        ...
                        if VAD2LRec.FINDFIRST() then
                            repeat
                                ...
                                if VAD2LRec."Pay Element Code" = Text000Txt then begin
                                    ...
                                    OTAmount := (DayAmount * DailyAttendanceLRec."OT Approved Hrs") / DailyAttendanceLRec."Actual Hrs";
                    ...
                    until PayElements.NEXT() = 0;
            until DailyAttendanceLRec.NEXT() = 0;
    ...
    begin
        ...
        if not Flag then begin
            PayYearLRec.SETRANGE("Year Type", 'ESI YEAR');
    ...
    begin
        ...
        TempProcSalary.SETRANGE("Add/Deduct", TempProcSalary."Add/Deduct"::Deduction);
        TempProcSalary.SETRANGE(Deducted, false);
        TempProcSalary.SETRANGE("Add/Deduct Code", Text0010Txt);
        if TempProcSalary.FINDFIRST() then
            if (TotalSalary >= TempProcSalary."Earned Amount") then begin
                ProcessedSalaryAdd2.RESET();
                ProcessedSalaryAdd2.SETRANGE("Employee Code", MonthlyAttendance."Employee Code");
    ...
    begin
        DA := 0;
        MonthlyAttendance2GRec.CALCFIELDS(Days);
        DailyAttendanceLRec.RESET();
        DailyAttendanceLRec.SETRANGE("Employee No.", MonAttendance."Employee Code");
        DailyAttendanceLRec.SETFILTER(Date, '%1..%2', MonthlyAttendance2GRec."Period Start Date", MonthlyAttendance2GRec."Period End Date");
        DailyAttendanceLRec.SETFILTER("C Off Hours", '<> 0');
        DailyAttendanceLRec.SETFILTER("C Off Hours", '>=4');
        if DailyAttendanceLRec.FINDFIRST() then begin
            repeat
                DailyAttendanceLRec."C Off Hours" := DailyAttendanceLRec."Actual Hrs";
                PayElementsLRec.SETRANGE("Employee Code", DailyAttendanceLRec."Employee No.");
                ...
                if PayElements.FINDFIRST() then
                    repeat
                        Total := 0;
                        PayElementsLRec2.SETFILTER("Effective Start Date", '<= %1', DailyAttendanceLRec.Date);
                        ...
                        if PayElementsLRec2.FINDFIRST() then
                            repeat
                                ...
                                if PayElementsLRec2."Pay Element Code" = Text000Txt then begin
                                    ...
                                    Basic := Total;
                                    DayAmount := (Total * 1) / MonthlyAttendance2GRec.Days;
                                    COffAmount := (DayAmount * DailyAttendanceLRec."C Off Hours") / DailyAttendanceLRec."Actual Hrs";
