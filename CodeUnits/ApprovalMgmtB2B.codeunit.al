codeunit 33001190 "Approval Mgmt B2B"
{
    trigger OnRun();
    begin
    end;
    ...
    PROCEDURE OnSendFinalSettlementForApproval(VAR FinalSettlementHeader: Record "Final Settlement Header B2B");
    BEGIN
    END;

    [IntegrationEvent(false, false)]
    PROCEDURE OnCancelFinalSettlementApprovalRequest(Var FinalSettlementHeader: Record "Final Settlement Header B2B");
    BEGIN
    END;

    PROCEDURE CheckFinalSettlementApprovalsWorkflowEnabled(VAR FinalSettlementHeader: Record "Final Settlement Header B2B"): Boolean;
    BEGIN
        IF NOT IsFinalSettlementApprovalsWorkflowEnabled(FinalSettlementHeader) THEN
            ERROR(NoWorkflowEnabledErr);

        EXIT(TRUE);
    END;

    PROCEDURE IsFinalSettlementApprovalsWorkflowEnabled(VAR FinalSettlementHeader: Record "Final Settlement Header B2B"): Boolean;
    BEGIN
        EXIT(WorkflowManagement.CanExecuteWorkflow(FinalSettlementHeader, WorkflowEventHandling.RunWorkflowOnSendFinalSettlementForApprovalCode()));
    END;

    //Amount To Text Code Starts >> B2BMMOn26Aug2022
 ...
 */
    ...
    //Amount To Text Code Ends<< B2BMMOn26Aug2022
    ...
    var
        ...
        //Amount To Text Variables Starts>> B2BMMOn26Aug2022
    ...
    //Amount To Text Variables Ends<< B2BMMOn26Aug2022
}
