report 33001364 "Check Report B2B"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports\Layout\Check.rdlc';
    Caption = 'Check';
    ...
    dataset
    {
        dataitem(VoidGenJnlLine; "Gen. Journal Line")
        {
            ...
            begin
                ...
                if (GetFilter("Line No.") <> '') or (GetFilter("Document No.") <> '') then
                    Error(
                      Text002Lbl, FieldCaption("Line No."), FieldCaption("Document No."));
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                column(PreprintedStub1; PreprintedStub)
                {
                }
                ...
                dataitem(PrintSettledLoop; "Integer")
                {
                                ...
                                case ApplyMethod of
                                    ...
                                    ApplyMethod::MoreLinesOneEntry:
                                        begin
                                            ...
                                            GenJnlLine2.TestField("Bank Payment Type", GenJnlLine2."Bank Payment Type"::"Computer Check".AsInteger());
                    ...
                    begin
                        ...
                        if GenJnlLine."Currency Code" <> '' then
                            NetAmount := StrSubstNo(Text063Lbl, GenJnlLine."Currency Code")
                        else begin
                            GLSetup.Get();
                            NetAmount := StrSubstNo(Text063Lbl, GLSetup."LCY Code");
                        end;
                    end;
                }
                    ...
                    if not TestPrint then begin
                        if UseCheckNo <> GenJnlLine."Document No." then begin
                            ...
                            if GenJnlLine3.Find('-') then
                                GenJnlLine3.FieldError("Document No.", StrSubstNo(Text013Lbl, UseCheckNo));
                        end;
            ...
            begin
                ...
                if not TestPrint then begin
                    ...
                    TestField("Bal. Account Type", "Bal. Account Type"::"Bank Account".AsInteger());
                    ...
                    if ("Account No." <> '') and ("Bal. Account No." <> '') then begin
                        ...
                        if "Account No." = '' then
                            FieldError("Account No.", Text004Lbl)
                        else
                            FieldError("Bal. Account No.", Text004Lbl);
                        ...
                        BalancingType::Customer:
                            begin
                                ...
                                if Cust.Blocked = Cust.Blocked::All then
                                    Error(Text064Lbl, Cust.FieldCaption(Blocked), Cust.Blocked, Cust.TableCaption, Cust."No.");
                                Cust.Contact := '';
                        ...
                        BalancingType::Vendor:
                            begin
                                ...
                                if Vend.Blocked in [Vend.Blocked::All, Vend.Blocked::Payment] then
                                    Error(Text064Lbl, Vend.FieldCaption(Blocked), Vend.Blocked, Vend.TableCaption, Vend."No.");
                                Vend.Contact := '';
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(ReprintChecks1; ReprintChecks)
                    {
                        ApplicationArea = Basic, Suite;
                    ...
                    field(PreprintedStub1; PreprintedStub)
                    {
                        ApplicationArea = Basic, Suite;
    ...
    var
        ...
        Text000Lbl: Label 'Preview is not allowed.';
        Text001Lbl: Label 'Last Check No. must be filled in.';
        Text002Lbl: Label 'Filters on %1 and %2 are not allowed.', Comment = '%1 =From, %2 = To';
        Text003Lbl: Label 'XXXXXXXXXXXXXXXX';
        Text004Lbl: Label 'must be entered.';
        Text005Lbl: Label 'The Bank Account and the General Journal Line must have the same currency.';
        Text008Lbl: Label 'Both Bank Accounts must have the same currency.';
        Text010Lbl: Label 'XXXXXXXXXX';
        Text011Lbl: Label 'XXXX';
        Text012Lbl: Label 'XX.XXXXXXXXXX.XXXX';
        Text013Lbl: Label '%1 already exists.', Comment = '%1 = Test';
        Text014Lbl: Label 'Check for %1 %2', Comment = '%1 = Test,%2 = Test2';
        Text016Lbl: Label 'In the Check report, One Check per Vendor and Document No.\must not be activated when Applies-to ID is specified in the journal lines.';
        Text019Lbl: Label 'Total';
        Text020Lbl: Label 'The total amount of check %1 is %2. The amount must be positive.', Comment = '%1 = Amount, %2 = Amount';
        Text021Lbl: Label 'VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID VOID';
        Text022Lbl: Label 'NON-NEGOTIABLE';
        Text023Lbl: Label 'Test print';
        Text024Lbl: Label 'XXXX.XX';
        Text025Lbl: Label 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
        Text026Lbl: Label 'ZERO';
        Text027Lbl: Label 'HUNDRED';
        Text028Lbl: Label 'AND';
        Text029Lbl: Label '%1 results in a written number that is too long.', Comment = '%1 = Result';
        Text030Lbl: Label ' is already applied to %1 %2 for customer %3.', Comment = '%1 = Result, %2 = Result , %3 =Customer';
        Text031Lbl: Label ' is already applied to %1 %2 for vendor %3.', Comment = '%1 = Result, %2 = Result , %3 =Vendor';
        ...
        NetAmount: Text[30];
        LineAmount2: Decimal;
        Text063Lbl: Label 'Net Amount %1', Comment = '%1 = Amount';
        Text064Lbl: Label '%1 must not be %2 for %3 %4.', Comment = '%1 = test,%2 = Test,%3 = Test,%4 = Test';
