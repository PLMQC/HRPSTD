report 33001360 "Posted Travel Exp. Stat B2b"
{
    // version B2BHR1.00.00

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports\Layout\Posted Travel Exp. Statement.rdlc';
    Caption = 'Posted Travel Exp. Statement';
    ApplicationArea = all;
    UsageCategory = ReportsAndAnalysis;
    dataset
    {
        dataitem("Posted Expense Header"; "Posted Expense Header B2B")
        {
            ...
            dataitem("Posted Expense Line"; "Posted Expense Line B2B")
            {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                begin
                    RemBlankRows := "Posted Expense Line".COUNT() mod 12;
