report 33001359 "Posted Travel Requisition B2B"
{
    // version B2BHR1.00.00

    DefaultLayout = RDLC;
    RDLCLayout = 'Reports\Layout\Posted Travel Requisition.rdlc';
    Caption = 'Posted Travel Requisition';
    ApplicationArea = all;
    UsageCategory = ReportsAndAnalysis;
    dataset
    {
        dataitem("Posted Travel Requisition"; "Posted Travel Requisition B2B")
        {
            ...
            dataitem("Posted Travel Requisition Line"; "Posted Travel Req. Line B2B")
            {
