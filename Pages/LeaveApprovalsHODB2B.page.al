page 33001512 "Leave Approvals HOD B2B"
{
    // version B2BHR1.00.00

    AutoSplitKey = true;
    Caption = 'Leave Approvals HOD';
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = Worksheet;
    ...
    SourceTableView = WHERE("Processed Status" = FILTER(<> Cancelled),
                            ...
                            Status = CONST("Pending for HOD Approval"),
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1102152014)
            {
                ...
                {
                    ApplicationArea = all;
                    ToolTip = 'Specifies The Carryout action';
                }
            ...
            group("P&ost")
            {
                ...
                action("&Approve")
                {
                    ...
                    begin
                        ...
                        if PostedLeave.FINDFIRST() then
                            if PostedLeave."Approved Status" = PostedLeave."Approved Status"::Applied then
                                ERROR(Text004Lbl);
                            ...
                            if PayApprovalSetup1.FINDFIRST() then
                                if PayApprovalSetup1."Additional Approver" <> '' then begin
                                    ...
                                    if LeaveApp.FINDFIRST() then
                                        repeat
                                            LeaveApp.Status := LeaveApp.Status::"Pending for Additional Approval";
                ...
                action("&Reject")
                {
                    ...
                    begin
                        ...
                        MODIFY();
                        MESSAGE(Text006Lbl, "Document No.");
                    end;
                }
                action(Post)
                {
    ...
    var
        ...
        Text004Lbl: Label 'Please selet the Approveall before posting';
        Text005Lbl: Label 'Leave Application %1 was approved and sent for further approval', Comment = '%1 = No';
        Text006Lbl: Label 'Leave Application %1 Rejected', Comment = '%1 = Document No';
    ...
    var
        ...
        Text012Lbl: Label '%1 has leaves %2 of %3', Comment = '%1 = Employee No ; %2 = Total  Leaves ;%3 = Creditinng intervals';
    begin
        CountCrIntervals := 0;
        TotalLeaves := 0;
